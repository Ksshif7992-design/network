      ...
      <Card noPadding className="border-gray-800 bg-gray-900/50">
         <div className="p-4 flex flex-wrap items-center gap-6">
                  ...
                  {(['Offer', 'Affiliate', 'Advertiser', 'Country'] as Dimension[]).map(dim => (
                    <button 
                      ...
                      className={`px-3 py-1.5 rounded-lg border text-[10px] font-black uppercase tracking-widest transition-all ${
                        groupBy.includes(dim) ? 'bg-blue-600/10 border-blue-500 text-blue-400' : 'bg-gray-800 border-gray-700 text-gray-500 hover:border-gray-600'
                      }`}
                    >
                      {dim}
                    </button>
            ...
            <div className="ml-auto flex items-center gap-2">
               <button className="p-2 bg-gray-800 border border-gray-700 rounded-lg text-gray-500 hover:text-blue-400 transition-all"><Settings2 size={16}/></button>
            </div>
         </div>
      </Card>
